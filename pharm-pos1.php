...
<body>
	...
	?>
			...
			<form method="post">
					...
					<input type="text" name="mdname" value="<?php echo isset($row4[3]) ? $row4[3] : ''; ?>" readonly><br><br>
					
					<label for="mloc">Location:</label>
					<input type="text" name="mdname" value="<?php echo isset($row4[5]) ? $row4[5] : ''; ?>" readonly><br><br>
