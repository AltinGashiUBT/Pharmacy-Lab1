	...
	include "config.php";
		...
		echo "<tr>";
			...
			echo "<td align=center>";
				...
				echo "<a class='button1 del-btn' href='inventory-delete.php?med_id=".$row['med_id']."' onclick='return confirm(\"Are you sure you want to delete this medicine?\");'>Delete</a>";
